...
generated quantities {
  ...
  sigma_player[1] = abs(normal_rng(0, 0.40));
  sigma_player[2] = abs(normal_rng(0, 0.35));
  sigma_player[3] = abs(normal_rng(0, 0.35));
  sigma_defender[1] = abs(normal_rng(0, 0.20));
  sigma_defender[2] = abs(normal_rng(0, 0.15));
  sigma_defender[3] = abs(normal_rng(0, 0.15));
  sigma_defteam[1] = abs(normal_rng(0, 0.15));
  sigma_defteam[2] = abs(normal_rng(0, 0.15));
  sigma_defteam[3] = abs(normal_rng(0, 0.15));
